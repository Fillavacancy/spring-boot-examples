...
/**
    ...
    public void createIndexTest() {
        ElasticsearchUtils.getAllIndices();
       */
...
/**
    ...
    public void addDataTest() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            ElasticsearchUtils.addData(JSONObject.parseObject(JSONObject.toJSONString(map)), "index", "about_test", String.valueOf(i));
        }
    }
...
/**
    ...
    public void deleteDataByIdTest() {
        ...
        for (int i = 0; i < 10; i++) {
            ElasticsearchUtils.deleteDataById("ymq_index", "about_test", String.valueOf(i));
        }
    }
...
/**
    ...
    public void updateDataByIdTest() {
        ...
        ElasticsearchUtils.updateDataById(JSONObject.parseObject(JSONObject.toJSONString(map)), "ymq_index", "about_test", String.valueOf(11));
    }
...
/**
    ...
    public void searchDataByIdTest() {
        Map<String, Object> map = ElasticsearchUtils.searchDataById("ymq_index", "about_test", String.valueOf(11), null);
